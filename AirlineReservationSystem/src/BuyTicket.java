...
public class BuyTicket {
    ...
    public static void buyingTicket(List<String> userInformation, List<String[]> userFlightInfo) throws IOException {
        int userDecision = 0;
        int flagInner = 0;
        String today = "";
        String todayAdded = "";
        ...
        List<String> linesCsvCountry = ManipulateCsv.readAllLinesCsv(ConstData.PATH_CSV_COUNTRY);
        // read cityData csv
        List<String> linesCsvCity = ManipulateCsv.readAllLinesCsv(ConstData.PATH_CSV_CITY);
        List<CityData> cityList = new ArrayList<CityData>();
        // read flightData csv
        List<String> linesCsvFlight = ManipulateCsv.readAllLinesCsv(ConstData.PATH_CSV_FLIGHT);
        ...
        System.out.println(ConstData.BORDER_LINE);
        // get today's date and 3 month later date
        ...
        while (flagInner == 0) {
            ...
            if (yyyyMmDd.compareTo(userDate) <= 0 && yyyyMmDdAdded.compareTo(userDate) >= 0) {
                ...
                System.out.println(yyyyMmDd.compareTo(userDate) + "" + yyyyMmDdAdded.compareTo(userDate));
            }
